...
//     typename std::span<const T>::size_type m_currentTokenIndex;
// };
...
// template<typename T, typename A>
// typename Parser<T, A>::ProductionRulesType 
// Parser<T, A>::GrammarAugmentation(ProductionRulesType&& initialProdRules) {
//     using namespace grammar;
